package co.sistemcobro.compromisos.session;
...
import co.sistemcobro.compromisos.bean.UsuarioHermes;
import co.sistemcobro.compromisos.util.Hash;
import co.sistemcobro.compromisos.bean.NavegacionBean;
...
public class LoginBean {
	...
	public String doLogin() {
		...
		return navegacionBean.redireccionInicioVer;
	}
